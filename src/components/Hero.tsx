    ...
    return (
        <section className="relative h-screen flex items-center justify-center overflow-hidden bg-black text-white">
            ...
            <div className="container mx-auto px-4 z-10 text-center">
                ...
                >
                    Build the Future <br /> with <span className="text-purple-500">Next.js</span>
                </motion.h1>
                ...
                >
                    Experience the power of modern web development with stunning animations and incredible performance.
                </motion.p>
